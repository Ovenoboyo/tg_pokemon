...
CREATE INDEX "fkIdx_201" ON "player"."user_pokemon" ("ev_id");
CREATE INDEX "fkIdx_204" ON "player"."user_pokemon" ("iv_id");
CREATE INDEX "fkIdx_82" ON "player"."user_pokemon" ("pokedex_no");
-- +migrate Down
