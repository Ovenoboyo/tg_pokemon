...
INSERT INTO public.move(
	name, element_type, damage, accuracy, max_pp)
	VALUES ('Tackle', 0, 4, 40, 100);

INSERT INTO public.move(
	name, element_type, damage, accuracy, max_pp)
	VALUES ('Sasta Tackle', 0, 4, 20, 100);

INSERT INTO public.move(
	name, element_type, damage, accuracy, max_pp)
	VALUES ('Aur Sasta Tackle', 0, 4, 10, 100);

INSERT INTO public.pokemon_move_bridge(
	pokedex_no, move_id, level)
	VALUES (0, 1, 1);
