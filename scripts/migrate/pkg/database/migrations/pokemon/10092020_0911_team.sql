...
CREATE TABLE "player"."team" (
    ...
    "pokemon_id_0" varchar(36) NOT NULL,
    "pokemon_id_1" varchar(36) NULL,
    "pokemon_id_2" varchar(36) NULL,
    "pokemon_id_3" varchar(36) NULL,
    "pokemon_id_4" varchar(36) NULL,
    "pokemon_id_5" varchar(36) NULL,
